--Readme document for Leo Chao, ychao13@uci.edu--
...
(c) Advanced features
- Interactive Javascript Canvas Animation: Implemented a custom particle system ('cranes.js'), which renders cranes that react to mouse movement. 
- Complex Page Layouts: Responsive card grids for projects and namecard/info which adapts to desktop and mobile.
...
- Canvas Animation Reference: https://developer.mozilla.org/en-US/docs/Web/API/Canvas_API
- Google Fonts: https://fonts.google.com/


6. What classmates or other individuals did you consult as part of this assignment? What did you discuss?
None, I did this assignment individually.


7. Is there anything special we need to know in order to run your code?
This portfolio is heavily based on the content and design of my personal Jekyll-based site, which is deployed on github pages at https://twleochao.github.io/.
But I have rebuilt the portfolio entirely from scratch using HTML/CSS/JS with no generators.
